...
class location {
	...
	var $center						= "10.299621, 123.898726";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
