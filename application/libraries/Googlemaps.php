...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCGuJ1tODP1BkrPudoGVYWhI0ZVQwPSrIw'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "10.3001568,123.8982494";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $clusterZoomOnClick			= FALSE;						// Whether the default behaviour of clicking on a cluster is to zoom into it
	...
	var $map_height					= "710px";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
	...
	var $map_type					= "STREET";				// The default MapType. Values accepted are 'HYBRID', 'ROADMAP', 'SATELLITE' or 'TERRAIN'
	...
	var $streetViewAddressControl	= FALSE;						// If set to FALSE will hide the Address control
	...
	var $streetViewZoomControl		= FALSE;						// If set to FALSE will hide the Zoom control
	...
	function Googlemapz($config = array())
	{
		if (count($config) > 0)
		{
