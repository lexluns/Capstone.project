  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
              ...
              <div class="contain">
                ...
                <?php echo form_open_multipart ('curator_Events/addevents');?>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
              ...
              <div class="contain">
                ...
                <?php echo form_open_multipart ('curator_Events/updateevents');?>
                      ...
                      <tr>
                       <td><p style="color: #4682b4; font-size: 20px; font-family: Raleway;"><b><?php echo $data_item->event_name;?></b></p></td>
                        ...
                        <td><center><a href="#" class="DeetsButton" id="viewbtn" data-toggle="modal" data-event_id="<?php echo "$data_item->event_id";?>" data-event_name="<?php echo "$data_item->event_name";?>" data-event_subname="<?php echo "$data_item->event_subname";?>" data-event_desc="<?php echo "$data_item->event_desc";?>" data-event_start="<?php echo "$data_item->event_start";?>" data-event_end="<?php echo "$data_item->event_end";?>" data-event_tags="<?php echo "$data_item->event_tags";?>" data-target="#viewEvent">View</a>
                          ...
                          <a href="<?php echo site_url('curator_Events/unfeature/'.$data_item->event_id.$data_item->event_label);?>" class="FeaturedButton"><span class="glyphicon glyphicon-star" title="Unfeature"></span></a>
                          <?php else : ?>
                          <a href="<?php echo site_url('curator_Events/feature/'.$data_item->event_id.$data_item->event_label);?>" class="NotFeaturedButton"><span class="glyphicon glyphicon-star" title="Feature"></span></a>
                          <?php endif; ?>
                          </center>
                        </td>               
                      </tr>
...
.then((willDelete) => {
  if (willDelete) {
     window.location = url+"index.php/curator_events/deleteEvents/"+id;
  } else {
    return false;
