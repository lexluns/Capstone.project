...
<html>
  <head>
    <meta charset="utf-8">
      ...
      <title>Curator Area | Profile</title>
...
/* END */ /* END *//* END */ /* END *//* END */ /* END *//* END */ /* END *//* END */ /* END *//* END */ /* END */
  ...
  <body>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-2">
            <a href="<?php echo base_url();?>index.php/curator_Home" style="text-decoration: none;"><img src="<?php echo base_url();?>assets/images/final.jpg" width = "350px" height = "70px" style="margin-bottom: -15px;">&nbsp;</a> 
          </div>
          ...
          <div class="container-fluid">
            ...
            <div id="navbar" class="collapse navbar-collapse">
              <ul class="nav navbar-nav">
                ...
                <li  class=""><a href="<?php echo base_url(); ?>index.php/curator_resource">Learning Resources</a></li>
                ...
                <div class="col-md-3">
                  <div class="list-group">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/curator_Home" class="list-group-item">
                        ...
                        <!-- 2 -->
                        <a href="<?php echo base_url(); ?>index.php/curator_Events" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Events <span class="badge"></span>
                        </a>
                        <!-- 3 -->
                        <a href="<?php echo base_url(); ?>index.php/curator_Gallery" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Collections <span class="badge"></span>
                        </a>
                        <!-- 4 -->
                        <a href="<?php echo base_url(); ?>index.php/curator_Schedule" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Schedule <span class="badge"></span>
                        </a>
                        <!-- 5 -->
                        <a href="<?php echo base_url(); ?>index.php/curator_resource" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Learning Resources <span class="badge"></span>
                        </a>
                        <!-- 6 -->
                        <a href="<?php echo base_url(); ?>index.php/curator_User" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> User Accounts <span class="badge"></span>
                        </a>
                        <!-- 7 -->
                        <hr>
                        <!-- 8 -->
...
<?php if($this->session->flashdata('error')) : ?>
                                      ...
                                      <div class="row">
                                        <div class="col-md-5">
                                          <div class="text-center">
                                           <!--  <?php foreach($curator_info->result() as $row) { ?> -->
                                            <img src="<?php echo $row->user_dp;?>" class="avatar img-circle" alt="avatar">
                                              ...
                                              <span class="label label-danger">&nbsp;C U R A T O R&nbsp;</span>
                                              <hr>
                                              <?php echo form_open_multipart('curator_Profile/upload_profile_image'); ?>
                                          ...
                                          <br>
                                            <!-- CHANGE PASS -->
                                              ...
                                              echo form_open_multipart('curator_Profile/changePassword',$attrib); ?>
                                            <form class="form-horizontal">
                                                                                                             <div class="form-group">
                       <input type="hidden" class="form-control" name="User_id" value="<?php echo $row->User_id;?>">
                          ...
                          <div class="col-sm-7">
                            <input type="password" class="form-control" name="oldpass" value="" required>
                                        ...
                                        <div class="col-md-7"><br>
                                          ...
                                          <?php $attrib = array('class' => 'form-horizontal'); 
                                          echo form_open_multipart('curator_Profile/InfoSubmit',$attrib); ?>
                                          <!-- <form class="form-horizontal" role="form"> -->
                                            ...
                                            <div class="form-group">
                                              <div class="col-sm-offset-3 col-sm-9">
                                                  <input type="submit" class="btn btn-success btn-sm" onclick="Success();" value="Edit Information">
                                              </div>
                                            </div>  
                                    <!-- </form> --><!-- FORM END INFO -->
                                          <?= form_close(); ?>
    ...
    <footer id="footer">
      ...
      <script src="<?php echo base_url();?>userassets/js/sweetalert-dev.js"></script>
