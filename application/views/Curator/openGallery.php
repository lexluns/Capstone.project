  ...
  <body>
   <header id="header">
    ...
    <section id="main">
     ...
     <a  href="<?php echo base_url(); ?>index.php/curator_register_artifact" style ="text-decoration:none; color: white;"> <button class="btn btn-success" type="button" style="margin-bottom: 10px;" title="Add Artifact">
          ...
          <div class="col-md-3">
                <?php 
                echo form_open_multipart ('curator_Gallery/search');?>
   ...
   <input type="text" class="search-query form-control" id="id_input" name="search" placeholder="Search Name" />
          ...
          <div class="col-md-1" >
           <?php if($this->session->flashdata('cancelbutt')) : ?>
                  <a href="<?php echo site_url('curator_Gallery/cancelsearch');?>">
...
?>
         ...
         <div style="margin-top: 10px; padding: 0;" class="col-md-<?php echo $bootstrapColWidth; ?>">
                  ...
                  <a href="<?php echo site_url('curator_Gallery/view/'.$img->arti_id);?>" style="text-decoration:none; background-position: center;"  >
                  <div class="content" >
    ...
    <footer id="footer">
        ...
        $(this).ready( function() {  
            $("#id_input").autocomplete({  
                ...
                function(req, add){  
                    $.ajax({  
                        url: "<?php echo base_url(); ?>index.php/curator_Gallery/lookup",  
                        dataType: 'json',  
                        type: 'POST',  
                        data: req,  
                        success:      
