...
.img-preview4 {
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-9">
           ...
           <div class="col-sm-1" style="margin-top: 5px; width: 2%;"><a href="<?php echo site_url('curator_Gallery/view/'.$data->arti_id);?>" style = "text-decoration-color: none; color: white;"><span class="glyphicon glyphicon-arrow-left" style="font-size: 20px; " title="Back"></span></a></div>

           <div class="col-sm-2" style="margin-top: 8px;"> <h3 class="panel-title">Update Item</h3></div>
  ...
  <div class="panel-body">
                ...
                <?php endif; ?>
                  ...
                  <?php
                echo form_open_multipart ('curator_edit_artifact/update');?>
        
              
                <div class="row">

                    <input type="hidden" value="<?php echo $data->arti_id; ?>" name="artiid">
                      <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label" style="font-size: 13px;">Accession number or catalogue number</label>
        <input type="text" style="width: 40%;" value="<?php echo $data->acc_number; ?>"  class="form-control" name="accnumber"  required=""  >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $data->classify; ?>"   class="form-control" name="classify" required="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $data->name_obj; ?>"   class="form-control" name="nameobj" required="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $data->name_art; ?>" class="form-control" name="nameartist" required="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data->material; ?>"   name="material" required="">
                    </div>
                   ...
                   <div class="form-group">
                        ...
                        <input type="date" class="form-control" value="<?php echo $data->date_acq; ?>"  name="dateacq" required="">
                  </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control" value="<?php echo $data->institution; ?>" name="institution" required="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control" value="<?php echo $data->owner; ?>" name="ownership" required="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"   class="form-control" value="<?php echo $data->locate; ?>" name="location" required="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control" value="<?php echo $data->place_orig; ?>" name="origin" required="">
                    </div>
              ...
              <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" style=" height: 130px;" required="required"  name="mode" ><?php echo $data->mode; ?></textarea>
              </div>
            ...
            <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" style=" height: 130px;"  name="descp" required="required"><?php echo $data->description; ?></textarea>
              </div>
                        ...
                        <textarea type="text" class="form-control" style=" height: 130px;"  name="conserv" required="required"> <?php echo $data->conserv; ?></textarea>
              </div>
        ...
        <input type="text" value="<?php echo $data->price; ?>" name="price" autocomplete="off" class="form-control numberOnly"/>
    </div> 
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data->collector; ?>"  name="collector" required="">
                  </div>


                            <?php if(form_error('collector')):?>
                            <div class="alert alert-danger" role="alert" align="center"> <?php echo form_error('collector')?>  </div>
                         <?php endif; ?>

                 <div class="form-group">
                        <label class="control-label" style="font-size: 13px">Cultural or Ethnic Group</label>
                        <input type="text" class="form-control" value="<?php echo $data->cultural; ?>"   name="culture" required="">
                  </div>
                 ...
                 <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data->function; ?>"   name="function" required="">
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <input type="text"   class="form-control" value="<?php echo $data->chronology; ?>" name="chronology" required="">
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <input type="text"   class="form-control" value="<?php echo $data->style; ?>" name="style" required="">
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <input type="text"   class="form-control" value="<?php echo $data->hist; ?>" name="history" required="">
                  </div>
                         ...
                         <?php endif; ?>
                  <input type="hidden" name="id" value="<?php echo $data->arti_id; ?>">

                   <div class="form-group">
                      <label class="control-label" style="font-size: 13px">Dimension</label>
                      <input type="text"  class="form-control" value="<?php echo $data->Dimensions; ?>" name="dimension" required="">
                  </div>


                                       <?php if(form_error('dimension')):?>
                            <div class="alert alert-danger" role="alert" align="center"> <?php echo form_error('dimension')?>  </div>
                         <?php endif; ?>

                  <div class="form-group">
                      <label class="control-label" style="font-size: 13px">References</label>
                      <input type="text"  class="form-control" value="<?php echo $data->reference; ?>" name="reference" required="">
                  </div>



                                       <?php if(form_error('reference')):?>
                            <div class="alert alert-danger" role="alert" align="center"> <?php echo form_error('reference')?>  </div>
                         <?php endif; ?>
             <div class="form-group">
                 <label >Restrictions for viewing</label>

                 <?php if($data->arti_restrict == 'restricted') : ?>
                   ...
                   <?php elseif($data->arti_restrict == 'museum') : ?>
                  <br><input type="radio" name="restri" value="restricted" > Restricted<br>
                   <input type="radio" name="restri" value="museum" checked=""> Museum<br>
                   <input type="radio" name="restri" value="public"> Public
                   	<?php elseif($data->arti_restrict == 'public') : ?>
                 <br><input type="radio" name="restri" value="restricted" > Restricted<br>
                   <input type="radio" name="restri" value="museum"> Museum<br>
                   <input type="radio" name="restri" value="public" checked=""> Public
                   <?php endif; ?>
            </div>
               ...
               <input type="submit" class="btn btn-success"  style="display: none;" id="where"></input>
                <?php echo form_close(); ?>
     ...
     <div id="carousel-example-generic"  data-interval="false" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="item active">
              <div class="box">
      <?php echo form_open_multipart ('curator_edit_artifact/pic1');?>

           <input type="hidden" value="<?php echo $data->arti_id; ?>" name="artiid">
            <div class="form-group">
                      <div class="main-img-preview">
                        <img class="thumbnail img-preview" src="<?php echo $data->arti_img1; ?>" title="Preview Logo">
                      </div>
                      <div class="input-group">
                      ...
                      <p class="help-block"  style="font: 12px 'Open Sans';">* For the 1st Slide</p>
                                          ...
                                          <p align="center">
                         <button type="submit" class="btn btn-success" value="Update">Update Picture</button>
                    </p> 
                <?php echo form_close(); ?>       
              </div>
            ...
            <div class="item">
              <div class="box">
                 <?php echo form_open_multipart ('curator_edit_artifact/pic2');?>
                      <input type="hidden" value="<?php echo $data->arti_id; ?>" name="artiid">
                  <div class="form-group">
                      <div class="main-img-preview">
                        <img class="thumbnail img-preview2" src="<?php echo $data->arti_img2; ?>" title="Preview Logo">
                      </div>
                      <div class="input-group">
            ...
            <div class="item">
              <div class="box">
                   <?php echo form_open_multipart ('curator_edit_artifact/pic3');?>
                  <input type="hidden" value="<?php echo $data->arti_id; ?>" name="artiid">
                            <div class="form-group">
                      <div class="main-img-preview">
                        <img class="thumbnail img-preview3" src="<?php echo $data->arti_img3; ?>" title="Preview Logo">
                      </div>
                      <div class="input-group">
                      ...
                      <?php echo form_close(); ?>  
                        ...
                        <div class="item">
              <div class="box">
                   <?php echo form_open_multipart ('curator_edit_artifact/pic4');?>
                        <input type="hidden" value="<?php echo $data->arti_id; ?>" name="artiid">
                            <div class="form-group">
                      <div class="main-img-preview">
                        <img class="thumbnail img-preview4" src="<?php echo $data->arti_img4; ?>" title="Preview Logo">
                      </div>
                      <div class="input-group">
  ...
  <p align="right">
              ...
              <input type="button" class="btn btn-success" id="now" value="Submit" ></input>
</p>
