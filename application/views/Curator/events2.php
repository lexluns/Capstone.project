  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
              ...
              <div class="contain">
                ...
                <?php echo form_open_multipart ('curator_Events2/updateevents');?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="event_name" id="event_name" pattern="[A-Za-z]+{ }"  title="Can only accept characters">
                    </div>
                    <div class="form-group">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
              ...
              <div class="contain">
                ...
                <?php echo form_open_multipart ('curator_Events2/addevents');?>
          
                    <div class="form-group">
                        <label class="control-label" style="font-size: 13px">Event Title</label>
                        <input type="text" class="form-control" name="etitle" pattern="[A-Za-z]+{ }"  title="Can only accept characters">
                    </div>
                    <div class="form-group">
                        <label class="control-label" style="font-size: 13px">Tagline</label>
                        <input type="text" class="form-control" name="etagline" pattern="[A-Za-z]+{/}+{ }" required title="Can only accept characters">
                    </div>
                    <div class="form-group">
                        <label class="control-label" style="font-size: 13px">Description</label>
                        <textarea rows="4" class="form-control"  name="edescription"  pattern="[A-Za-z]+{ }" required title="Can only accept characters"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label" style="font-size: 13px">Date Start</label>
                    ...
                    <div class="form-group">
                        <label >Post Event Photo</label>
                        <input type="file" class="form-control" name="eventdp" >
                   </div>
...
<div class="modal fade" id="viewEvent" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>index.php/curator_Events">Events</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="<?php echo base_url(); ?>index.php/curator_Events" class="list-group-item  active main-color-bg"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Events <span class="badge"></span></a>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <a href="<?php echo base_url(); ?>index.php/curator_Events">
                <button type="button" class="ViewButton" title="List View">
                <span class="glyphicon glyphicon-th-list"></span>
                </button></a>
                <a href="<?php echo base_url(); ?>index.php/curator_Events2">
         ...
         <!--  <div class="col-md-3">
          <select class="  search-query form-control"  style="width: 100%;">
          <option value="volvo">All Events</option>
          <option value="volvo">Past Events</option>
          <option value="saab">Upcoming Events</option>
          <option value="mercedes">Featured Events</option>
          </select>
          </div>
 ...
 -->
            ...
            <div class="wrapper list" style="padding: 2%;"> 
             ...
             <!--  Event Table -->
              ...
              <div class="row" style="margin-top: 10px;">
                  ...
                  <div style="margin-top: 10px;" class="col-md-<?php echo $bootstrapColWidth; ?>">
                  <div>
                 <a href="#" id="viewbtn" data-toggle="modal" data-event_id="<?php echo "$data_item->event_id";?>" data-event_name="<?php echo "$data_item->event_name";?>" data-event_subname="<?php echo "$data_item->event_subname";?>" data-event_desc="<?php echo "$data_item->event_desc";?>" data-event_start="<?php echo "$data_item->event_start";?>" data-event_end="<?php echo "$data_item->event_end";?>" data-event_tags="<?php echo "$data_item->event_tags";?>" data-target="#viewEvent">
                  <img class="eventdp"  style="width: 100%; height: 100%;" src="<?php echo $data_item->event_photo;?>">
                </a>
                  </div>
                <a href="#" id="viewbtn" data-toggle="modal" data-event_id="<?php echo "$data_item->event_id";?>" data-event_name="<?php echo "$data_item->event_name";?>" data-event_subname="<?php echo "$data_item->event_subname";?>" data-event_desc="<?php echo "$data_item->event_desc";?>" data-event_start="<?php echo "$data_item->event_start";?>" data-event_end="<?php echo "$data_item->event_end";?>" data-event_tags="<?php echo "$data_item->event_tags";?>" data-target="#viewEvent">
                  <center><p style="margin-top: 10px; font-family: Raleway; color: black;"><b><?php echo $data_item->event_name;?></b></p></center>
                </a>
                  <center><a href="#" onclick="editeventbtn('<?= $data_item->event_id?>','<?= $data_item->event_name?>', '<?= $data_item->event_subname?>', '<?= $data_item->event_desc?>', '<?= $data_item->event_start?>', '<?= $data_item->event_end?>', '<?= $data_item->event_tags?>')" class="EditButton">Edit</a> <a onclick="deleteconfirm(<?php echo $data_item->event_id;?>);" class="DeleteButton">Delete</a></center>
                  </div>   
  ...
  <script>
    ...
    <script>
        function editeventbtn(event_id,event_name,event_subname,event_desc,event_start,event_end,event_tags)
        {
         ...
         function vieweventbtn(event_id,event_name,event_subname,event_desc,event_start,event_end,event_tags)
        {
...
.then((willDelete) => {
  if (willDelete) {
     window.location = url+"index.php/curator_events2/deleteEvents/"+id;
  } else {
    return false;
