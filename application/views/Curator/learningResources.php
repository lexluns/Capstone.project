      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li  class="active"><a href="<?php echo base_url(); ?>index.php/curator_resource">Learning Resources</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="<?php echo base_url(); ?>index.php/curator_resource" class="list-group-item  active main-color-bg"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Learning Resources <span class="badge"></span></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <?php echo form_open_multipart('curator_resource/createResource'); ?>
        <div class="form-group">
          <label>Author(s)</label>
          <input type="hidden" class="form-control" name="resource_id" placeholder="Resource ID" value="">
          <input type="text" class="form-control" name="resourceAuthor" value="" required>
        </div>
         <div class="form-group">
          <label>Title</label>
          <input type="text" class="form-control" name="resourceTitle" value="" required>
        </div>
        <div class="form-group">
          <label>Year of Publication</label><span class="year">&nbsp;*Must be a valid year</span>
          <input type="number" class="form-control" name="date_pub" min="1500" max="4000" required>
        </div>
        <div class="form-group">
          <label>Journal/Book</label>
          <input type="text" class="form-control" name="journal_book" value="" required>
        </div>
        <div class="form-group">
          <label>Place of Publication</label>
          <input type="text" class="form-control" name="place_of_publication" value="" required>
        </div>
        <div class="form-group">
...
<div class="modal fade" id="editLearning" tabindex="-1" role="dialog" aria-labelledby="myModalLearning">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <?php echo form_open_multipart('curator_resource/updateResources'); ?>
        <div class="form-group">
          <label>Author(s)</label>
          <input type="hidden" class="form-control" name="resource_id" id="resource_id" placeholder="Resource ID" value="">
          <input type="text" class="form-control" name="resourceAuthor" id="resourceAuthor" value="" required>
        </div>
         <div class="form-group">
          <label>Title</label>
          <input type="text" class="form-control" name="resourceTitle" id="resourceTitle" value="" required>
        </div>
        <div class="form-group">
          <label>Year of Publication</label><span class="year">&nbsp;*Must be a valid year</span>
        ...
        <div class="form-group">
          <label>Journal/Book</label>
          <input type="text" class="form-control" name="journal_book" id="journal_book" value="" required>
        </div>
        <div class="form-group">
          <label>Place of Publication</label>
          <input type="text" class="form-control" name="place_of_publication" id="place_of_publication" value="" required>
        </div>
        <div class="form-group">
          <label>Publisher</label>
          <input type="text" class="form-control" name="publisher" id="publisher" value="" required>
        </div>
        <div class="form-group">
          <label>Restriction Type</label>
          <div class="radio">
...
<div class="modal fade" id="sendLearning" tabindex="-1" role="dialog" aria-labelledby="myModalLearning">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <?php echo form_open_multipart('curator_resource/ressend'); ?>
      <div class="modal-header">
    ...
    <input type="email" class="form-control" name="resource_email" id="resource_email" value="" placeholder="Enter user email">
          </div>
        <!-- <div class="modal-footer"> -->
...
function myFunc($uname) {
   document.getElementById("resource_email").innerHTML = $uname;
}
...
.then((willDelete) => {
  if (willDelete) {
     window.location = url+"index.php/curator_resource/deleteResources/"+id;
  } else {
    return false;
