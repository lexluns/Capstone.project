...
<h1 style="font-style: Raleway;">Learning Resources</h1><br>
    ...
    <ul class="nav nav-tabs" style="margin-bottom: 10px; margin-left: 10px;">
      <li role="presentation" class="active">
        ...
        <li role="presentation"><a href="<?php echo base_url();?>index.php/guest_reresource" class="tabtab"><span class="glyphicon glyphicon-ok"></span> Received Resources</a></li>
      </ul>
...
<center>
 ...
 <div class="error-template">
                <h1>
                    Oops!</h1>
                <h2>
                    There are no resources available</h2>
                <div class="error-details">
                    Sorry, there may be no resources yet please contact the administrator for details.
                </div>
            </div>
            </div>
