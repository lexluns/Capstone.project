...
.img-preview4 {
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-9">
           ...
           <div class="col-sm-1" style="margin-top: 5px; width: 2%;"><a href="<?php echo site_url('staff_Gallery/view/'.$data->arti_id);?>" style = "text-decoration-color: none; color: white;"><span class="glyphicon glyphicon-arrow-left" style="font-size: 20px; " title="Back"></span></a></div>
  ...
  <div class="panel-body">
                ...
                <?php endif; ?>
                  ...
                  <?php
                echo form_open_multipart ('staff_Gallery/update');?>
        ...
        <input type="text" style="width: 40%;" value="<?php echo $data->acc_number; ?>"  class="form-control" name="accnumber"  required=""  >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data->material; ?>"   name="material" >
                    </div>
     ...
     <div id="carousel-example-generic"  data-interval="false" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="item active">
              <div class="box">
      <?php echo form_open_multipart ('staff_Gallery/pic1');?>
           ...
           <input type="hidden" value="<?php echo $data->arti_id; ?>" name="artiid">
            ...
            <div class="item">
              <div class="box">
                 <?php echo form_open_multipart ('staff_Gallery/pic2');?>
                      <input type="hidden" value="<?php echo $data->arti_id; ?>" name="artiid">
                  <div class="form-group">
                      <div class="main-img-preview">
            ...
            <div class="item">
              <div class="box">
                   <?php echo form_open_multipart ('staff_Gallery/pic3');?>
                  <input type="hidden" value="<?php echo $data->arti_id; ?>" name="artiid">
                            <div class="form-group">
                      <div class="main-img-preview">
                      ...
                      <?php echo form_close(); ?>  
                        ...
                        <div class="item">
              <div class="box">
                   <?php echo form_open_multipart ('staff_Gallery/pic4');?>
                        <input type="hidden" value="<?php echo $data->arti_id; ?>" name="artiid">
                            <div class="form-group">
                      <div class="main-img-preview">
