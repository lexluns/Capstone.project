  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
              ...
              <div class="contain">
                ...
                <?php echo form_open_multipart ('staff_Events2/updateevents');?>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
              ...
              <div class="contain">
                ...
                <?php echo form_open_multipart ('staff_Events2/addevents');?>
...
.then((willDelete) => {
  if (willDelete) {
     window.location = url+"index.php/staff_events2/deleteEvents/"+id;
  } else {
    return false;
