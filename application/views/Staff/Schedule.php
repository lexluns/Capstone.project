...
<html lang="en">
  <head>
    ...
    <title>Staff Area | Schedule</title>
    <!-- Bootstrap core CSS -->
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("staff_Schedule/add_event"), array("class" => "form-horizontal")) ?>
      <div class="form-group">
       ...
       <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control form_datetime" name="start_date" required="" readonly>
                </div>
        </div>
        ...
        <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control form_datetime" name="end_date" required="" readonly>
                </div>
        </div>
      <div class="form-group">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("staff_Schedule/edit_event"), array("class" => "form-horizontal")) ?>
      ...
      <div class="form-group">
        ...
        <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading">Start Date</label>
                <div class="col-md-8">
                    <input type="text" class="form-control form_datetime" name="start_date" required="" id="start_date">
                </div>
        </div>
        <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading">End Date</label>
                <div class="col-md-8">
                    <input type="text" class="form-control form_datetime" name="end_date" required="" id="end_date">
                </div>
        </div>
        <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading">Notes</label>
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>index.php/staff_Schedule">Schedule</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">         
              ...
              <a href="<?php echo base_url(); ?>index.php/staff_Schedule" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Schedule <span class="badge"></span></a>
                    ...
                    <div class="container-fluid">
                        ...
                        eventSources: [
                     {
                        events: function(start, end, timezone, callback) {
                             $.ajax({
                            url: "<?php echo base_url(); ?>index.php/staff_Schedule/get_events",
                            dataType: 'json',
                            data: {
                            start: start.unix(),
                            end: end.unix()
