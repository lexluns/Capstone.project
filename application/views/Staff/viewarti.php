          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                   <div class="row">
                   <div class="col-sm-1" style="margin-top: 5px; width: 2%;"><a href="<?php echo site_url('staff_Gallery');?>" style = "text-decoration-color: none; color: white;"><span class="glyphicon glyphicon-arrow-left" style="font-size: 20px; " title="Back"></span></a></div>
...
<?php foreach($retdata as $data) : ?>
              <div class="container-fluid">
                ...
                <div class="row">
                     ...
                     <a  href="<?php echo site_url('staff_Gallery/viewupdate/'.$data->arti_id);?>" style ="text-decoration:none; color: white;"> <button class="btn btn-primary" type="button" style="margin-bottom: 10px;" title="Update Item">
          <span class="glyphicon glyphicon-pencil"></span></button></a>

<!-- <?php echo site_url('staff_Gallery/delete/'.$data->arti_id);?> -->
         ...
         <a  href="<?php echo site_url('staff_Gallery/pdf/' .$data->arti_id);?> " target="_blank" style ="text-decoration:none; color: white;"> <button class="btn btn-default" type="button" style="margin-bottom: 10px;" title="Print report">
...
.then((willDelete) => {
  if (willDelete) {
     window.location = url+"index.php/staff_Gallery/delete/"+id;
  } else {
    return false;
