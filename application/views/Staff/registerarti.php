...
<html lang="en">
  <head>
    ...
    <title>Staff Area | Register Item</title>
    ...
    <section id="main">
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                                  <div class="row">
                    <div class="col-sm-1" style="margin-top: 5px; width: 3%; "><a href="<?php echo base_url(); ?>index.php/staff_Gallery" style = "text-decoration-color: none; color: white;"><span class="glyphicon glyphicon-arrow-left" style="font-size: 20px; " title="Back to gallery"></span></a></div>
      ...
      <div class="panel-body">
                ...
                <?php endif; ?>
                 ...
                 <?php
                echo form_open_multipart ('staff_register_artifact/addarti');?>
...
$.ajax(
    {
        type:"post",
        url: "<?php echo base_url(); ?>index.php/staff_register_artifact/filename_exists",
