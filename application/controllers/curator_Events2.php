...
class curator_Events2 extends CI_Controller {
...
public function index()
    ...
    if ($type == 'Curator') {
        $config = array();
        $config["base_url"] = base_url() . "index.php/curator_Events2/index";
        ...
        $data["links"] = $this->pagination->create_links();
            $this->load->view('curator/events2',$data);
