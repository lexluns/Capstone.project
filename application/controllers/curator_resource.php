...
class curator_resource extends CI_Controller {
	...
	public function index()
	{
		...
		$data['learning'] = $this->resource_model->viewAllresourcesCurator();
		$data['display']=$this->m_user_curator->notadmin($id);
		$this->load->view('curator/learningResources', $data);
...
function do_upload_file($filename) {
		...
		if ( ! $this->upload->do_upload($filename)) {
        	...
        	$this->load->view('curator/learningResources', $error);
		...
		if (empty($_FILES['resourceFile']['name']))
{
	...
	// function do_upload_file_update($filename) {

	// 	$config['upload_path'] 		= './assets/documents/';
	// 	$config['allowed_types'] 	= 'doc|docx|pdf|odt|rtf|tex|txt|wks|wps|wpd|jpeg|jpg|gif|png';
	// 	$config['max_size']       	=  99999999999;
	// 	$config['max_width']      	=  99999999999;
	// 	$config['max_height']     	=  99999999999;
 ...
 // 			$file =$this->upload->data();
	...
	// function do_upload_img_update($filename) {
 ...
 // 			$file =$this->upload->data();
	...
	public function updateResources() {
		...
		if(isset($_FILES['resourceImage']) && $_FILES['resourceImage']['name'] != ''){
			$config['upload_path'] 		= './assets/documents/';
			$config['allowed_types'] 	= 'doc|docx|pdf|odt|rtf|tex|txt|wks|wps|wpd|png|jpg|jpeg';
			$config['max_size']       	=  99999999999;
			$config['max_width']      	=  99999999999;
			$config['max_height']     	=  99999999999;
